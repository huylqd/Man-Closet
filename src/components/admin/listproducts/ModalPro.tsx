...
import { createPro, updatePro } from "@/services/products/products";
      ...
      <div className=" overflow-y-auto relative p-4 w-full max-w-3xl h-full md:h-auto">
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <form action="" onSubmit={handleSubmit(onHandleSubmit)}>
            <div className="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                ...
                >
                  ...
                  {cate?.map((item: any) => {
                    return (
                      <option selected={product.categoryId} value={item._id}>
                        {item.name}
                      </option>
                    );
                  })}
            ...
            <button
              type="reset"
              className="text-white inline-flex items-center bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800"
            >
              Reset
            </button>
          </form>
