                ...
                <form action="" className='flex flex-col gap-4 lg:w-2/4'>
                    ...
                    <div className="md:flex-1 px-4">
                        ...
                        <div className="flex bottom-0 left-0 justify-center pb-4 space-x-4 w-full">
                            <button type="button" className="text-white w-full inline-flex items-center bg-yellow-500 hover:bg-yellow-600 justify-center focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:focus:ring-primary-800">
