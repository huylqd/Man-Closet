  ...
  return (
    <>
      ...
      >
        ...
        <h5 className="text-medium text-lg">{productName}</h5>
      </div>
    </>
  );
};
    ...
    <div className="relative w-[460px] bg-white dark:bg-zinc-900  rounded shadow-md">
      ...
      <div className="p-3 md:p-6">
        <ul>
          ...
          {productsSearched.length === 0 && (
            <div>
              <div className="bg-gray-100/50 rounded min-h-[160px] w-full flex items-center flex-col gap-2 justify-center">
                <Inbox className="w-8 h-8 text-zinc-400" />
                <h4 className="text-center text-zinc-400 text-medium text-md">
                  Rỗng
                </h4>
              </div>
            </div>
