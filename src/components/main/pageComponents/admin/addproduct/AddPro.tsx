        ...
        <form action="#" onSubmit={handleSubmit(onHandleSubmit)}>
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div className="sm:col-span-2">
              <label form="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Name</label>
            ...
            <div className="w-full">
              <label form="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity</label>
            ...
            <div>
              <label form="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
            ...
            <div>
              <label form="item-weight" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image</label>
            ...
            <div>
              <label form="item-weight" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color</label>
            ...
            <div>
              <label form="item-weight" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Size</label>
